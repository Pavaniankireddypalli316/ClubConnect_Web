...
<div class="outside">
    <div class="container">
        ...
        <?php
            ...
            {
                $query = "SELECT * FROM facultydetails WHERE facultyid = '$user'";
            ...
            if ($userDetails) {
                ...
                echo "<p>FacultyId: " . $userDetails['facultyid'] . "</p>";
                ...
                echo '<button><a href="facprofileedit.php"> Change Password</a></button>';
