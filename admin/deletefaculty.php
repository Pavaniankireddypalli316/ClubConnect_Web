<?php 
    ...
    $sql = "UPDATE facultydetails SET password='$randomNumber',name='DEACTIVATED' WHERE facultyid='$id'";
    ...
    if($res==true)
    {
        ...
        $_SESSION['delete'] = "<div class='success'>Faculty Deleted Successfully.</div>";
    ...
    else
    {
        ...
        $_SESSION['delete'] = "<div class='error'>Failed to Delete Faculty. Try Again Later.</div>";
        header('location:'.SITEURL.'admin/managefaculty.php');
    }
